...
from model import FreeVC_commons as commons
from model import FreeVC_modules as modules

from torch.nn import Conv1d, ConvTranspose1d, AvgPool1d, Conv2d
from torch.nn.utils import weight_norm, remove_weight_norm, spectral_norm
from model.FreeVC_commons import init_weights, get_padding
...
class SynthesizerTrn(nn.Module):
  ...
  def infer(self, c, g=None, mel=None, c_lengths=None):
    ...
    # print("checking d dimension:", z_p.shape) # [1, 192, 149] for 3s input audio
